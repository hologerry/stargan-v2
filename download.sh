...
if [ $FILE == "all" ] || [ $FILE == "pretrained-network-celeba-hq" ]; then
...
if  [ $FILE == "all" ] || [ $FILE == "pretrained-network-afhq" ]; then
...
if  [ $FILE == "all" ] || [ $FILE == "celeba-hq-dataset" ]; then
...
if  [ $FILE == "all" ] || [ $FILE == "afhq-dataset" ]; then
