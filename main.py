...
if __name__ == '__main__':
    ...
    # face alignment
    parser.add_argument('--wing_path', type=str, default='stargan-v2/checkpoints/wing.ckpt')
    parser.add_argument('--lm_path', type=str, default='stargan-v2/checkpoints/celeba_lm_mean.npz')
